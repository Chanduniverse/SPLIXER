...
public class main {
	...
	public static void main(String[] args) throws UnsupportedAudioFileException, IOException {
		...
		System.out.println("Before new wav");
		WaveFile wav = new WaveFile(tibecut);
		System.out.println("After new wav");
		for (int i = 0; i < wav.getFramesCount(); i++) {
			amplitude = amplitude + wav.getSampleInt(i);
			System.out.println();
			if (i == wav.getSampleInt(140) - 1) {
